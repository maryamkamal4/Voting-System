    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_token', models.CharField(blank=True, max_length=40, null=True, verbose_name='registration token')),
                ...
                ('halka', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='account.halka')),
